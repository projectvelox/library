	...
	<div class="container">
		...
		<div class="dashboard-container">
			<?php 
				...
				$result = mysqli_query($con,"SELECT CONCAT(MONTHNAME(log_in), ' ', YEAR(log_in)) AS monthly FROM logs GROUP BY CONCAT(MONTHNAME(log_in), ' ', YEAR(log_in)) ORDER BY MONTHNAME(log_in), YEAR(log_in) ASC");
